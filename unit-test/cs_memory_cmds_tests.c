...
void CS_DisableMemoryCmd_Test(void)
{
    ...
    CS_DisableMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));

    /* Verify results */
    UtAssert_True(CS_AppData.HkPacket.MemoryCSState == CS_STATE_DISABLED,
                  "CS_AppData.HkPacket.MemoryCSState = CS_STATE_DISABLED");

    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_DISABLE_MEMORY_INF_EID);
...
void CS_EnableMemoryCmd_Test(void)
{
    ...
    /* Execute the function being tested */
    CS_EnableMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));

    /* Verify results */
    UtAssert_True(CS_AppData.HkPacket.MemoryCSState == CS_STATE_ENABLED,
                  "CS_AppData.HkPacket.MemoryCSState = CS_STATE_ENABLED");

    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_ENABLE_MEMORY_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_Computed(void)
{
    ...
    /* Execute the function being tested */
    CS_ReportBaselineEntryIDMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));

    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_BASELINE_MEMORY_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_NotYetComputed(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_NO_BASELINE_MEMORY_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void CS_ReportBaselineEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_BASELINE_INVALID_ENTRY_MEMORY_ERR_EID);
...
void CS_RecomputeBaselineMemoryCmd_Test_Nominal(void)
{
    ...
    /* Execute the function being tested */
    CS_RecomputeBaselineMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_RECOMPUTE_MEMORY_STARTED_DBG_EID);
...
void CS_RecomputeBaselineMemoryCmd_Test_CreateChildTaskError(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_RECOMPUTE_MEMORY_CREATE_CHDTASK_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void CS_RecomputeBaselineMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_RECOMPUTE_INVALID_ENTRY_MEMORY_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void CS_RecomputeBaselineMemoryCmd_Test_RecomputeInProgress(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_RECOMPUTE_MEMORY_CHDTASK_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void CS_EnableEntryIDMemoryCmd_Test_Nominal(void)
{
    ...
    /* Execute the function being tested */
    CS_EnableEntryIDMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_ENABLE_MEMORY_ENTRY_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void CS_EnableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_ENABLE_MEMORY_INVALID_ENTRY_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void CS_DisableEntryIDMemoryCmd_Test_Nominal(void)
{
    ...
    /* Execute the function being tested */
    CS_DisableEntryIDMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_DISABLE_MEMORY_ENTRY_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void CS_DisableEntryIDMemoryCmd_Test_InvalidEntryErrorEntryIDTooHigh(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_DISABLE_MEMORY_INVALID_ENTRY_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void CS_GetEntryIDMemoryCmd_Test_Nominal(void)
{
    ...
    /* Execute the function being tested */
    CS_GetEntryIDMemoryCmd((CFE_SB_Buffer_t *)(&CmdPacket));

    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_GET_ENTRY_ID_MEMORY_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void CS_GetEntryIDMemoryCmd_Test_AddressNotFound(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, CS_GET_ENTRY_ID_MEMORY_NOT_FOUND_INF_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
