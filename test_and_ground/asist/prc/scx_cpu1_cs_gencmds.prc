...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_NOOP_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1000) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_NOOP_INF_EID,"."
  ut_setrequirements CS_1000, "F"
  ut_setrequirements CS_1003, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", "TST_CS", TST_CS_SET_COUNTERS_INF_EID, "INFO", 1

/SCX_CPU1_TST_CS_SetCounters
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_CS_SET_COUNTERS_INF_EID,"."
endif
...
if (SCX_CPU1_CS_CMDPC > 0) AND (SCX_CPU1_CS_CMDEC > 0) AND ;;
   (SCX_CPU1_CS_EepromEC > 0) AND (SCX_CPU1_CS_MemoryEC > 0) AND ;;
   (SCX_CPU1_CS_TableEC > 0) AND (SCX_CPU1_CS_AppEC > 0) AND ;;
   (SCX_CPU1_CS_CFECoreEC > 0) AND (SCX_CPU1_CS_OSEC > 0) AND ;;
   (SCX_CPU1_CS_PASSCTR > 0) THEN
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed (1001;1003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RESET_DBG_EID,"."
...
write "CMDPC     = ", SCX_CPU1_CS_CMDPC
write "CMDEC     = ", SCX_CPU1_CS_CMDEC
write "EEPROMEC  = ", SCX_CPU1_CS_EepromEC
write "MemoryEC  = ", SCX_CPU1_CS_MemoryEC
write "TableEC   = ", SCX_CPU1_CS_TableEC
write "AppEC     = ", SCX_CPU1_CS_AppEC
write "CFECoreEC = ", SCX_CPU1_CS_CFECoreEC
write "OSEC      = ", SCX_CPU1_CS_OSEC
write "PassCtr   = ", SCX_CPU1_CS_PASSCTR
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_ONESHOT_STARTED_DBG_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_ONESHOT_FINISHED_INF_EID, "INFO", 2

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=SCX_CPU1_TST_CS_StartAddr[1] RegionSize=2048 MaxBytes=32
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;8002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_8002, "F"
endif

;; Verify the telemetry flag is set to TRUE (8002)
if (p@SCX_CPU1_CS_OneShotInProgress = "True") then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (8002.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_FINISHED_INF_EID,"."
...
if (p@SCX_CPU1_CS_OneShotInProgress = "False") then
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=SCX_CPU1_TST_CS_STARTADDR[1]+10 RegionSize=2048 MaxBytes=16
...
write ";  memory region. "
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_ONESHOT_MEMVALIDATE_ERR_EID,"ERROR",1

local startAddr = SCX_CPU1_TST_CS_STARTADDR[1] + SCX_CPU1_TST_CS_SIZE[1]
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=startAddr RegionSize=2048 MaxBytes=2048
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_MEMVALIDATE_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=SCX_CPU1_TST_CS_STARTADDR[1] RegionSize=SCX_CPU1_TST_CS_SIZE[1] MaxBytes=0
...
if (SCX_CPU1_CS_LastOneShotRate = CS_DEFAULT_BYTES_PER_CYCLE) then
  write "<*> Passed (8002.3) - One shot rate is set as expected."
  ut_setrequirements CS_80023, "P"
else
  write "<!> Failed (8002.3) - One shot rate set to '",SCX_CPU1_CS_LastOneShotRate,"'. Expected '",CS_DEFAULT_BYTES_PER_CYCLE,"'"
...
write ";  command.   "
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_ONESHOT_CANCELLED_INF_EID,"INFO", 1

local cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Cancel One Shot Command
/SCX_CPU1_CS_CancelOneShot
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;8003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_CANCELLED_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_8003, "F"
endif
...
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=SCX_CPU1_TST_CS_STARTADDR[1] RegionSize=SCX_CPU1_TST_CS_SIZE[1] MaxBytes=2048
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;8002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ONESHOT_CANCEL_NO_CHDTASK_ERR_EID, "ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_CANCEL_NO_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_CC1_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
  
;; CPU1 is the default
rawcmd = "189Fc0000001AA00"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CS_MID_ERR_EID, "."
  ut_setrequirements CS_1004, "F"
endif
...
if (errcnt = SCX_CPU1_CS_CMDEC) then
...
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=SCX_CPU1_TST_CS_STARTADDR[2] RegionSize=2048 MaxBytes=6
...
;; Check for the finished event message
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1, 400
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (8002.1) - Expected Event Msg ",CS_ONESHOT_FINISHED_INF_EID," rcv'd."
  ut_setrequirements CS_80021, "P"
else
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_gencmds"
write ";*********************************************************************"
ENDPROC
