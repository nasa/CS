...
SCX_CPU1_CS_TBL_DEF_TABLE[1].Name = tblResTblName
SCX_CPU1_CS_TBL_DEF_TABLE[2].State = CS_STATE_ENABLED
SCX_CPU1_CS_TBL_DEF_TABLE[2].Name = "LC.LC_ADT"
SCX_CPU1_CS_TBL_DEF_TABLE[3].State = CS_STATE_DISABLED
SCX_CPU1_CS_TBL_DEF_TABLE[3].Name = "LC.LC_WDT"
SCX_CPU1_CS_TBL_DEF_TABLE[4].State = CS_STATE_DISABLED
SCX_CPU1_CS_TBL_DEF_TABLE[4].Name = memDefTblName
...
s create_tbl_file_from_cvt (hostCPU,defTblId,"Table Definition Table Load 1","tbl_def_tbl_ld_3",tblDefTblName,"SCX_CPU1_CS_TBL_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_tdt5                              "
write ";*********************************************************************"
ENDPROC
