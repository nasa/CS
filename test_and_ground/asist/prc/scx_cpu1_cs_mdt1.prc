...
s create_tbl_file_from_cvt (hostCPU,defTblId,"User Memory Definition Table Load 1","usrmem_def_ld_1",memDefTblName,"SCX_CPU1_CS_MEM_DEF_TABLE[0].State",endmnemonic)


write ";*********************************************************************"
write ";  End procedure scx_cpu1_cs_mdt1                              "
write ";*********************************************************************"
ENDPROC
