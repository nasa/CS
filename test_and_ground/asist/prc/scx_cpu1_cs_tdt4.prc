...
s create_tbl_file_from_cvt (hostCPU,defTblId,"Table Definition Empty Table Load","tbldefemptytable",tblDefTblName,"SCX_CPU1_CS_TBL_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_tdt4                              "
write ";*********************************************************************"
ENDPROC
