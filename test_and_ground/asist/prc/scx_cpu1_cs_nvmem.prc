...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=eeDefTblName
...
/SCX_CPU1_TBL_ACTIVATE ATableName=eeDefTblName
...
write ";*********************************************************************"
s get_tbl_to_cvt (ramDir,eeDefTblName,"A","cpu1_eedeftbl1_9",hostCPU,defTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl2_1",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_EEPROM_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Enable EEPROM Command
/SCX_CPU1_CS_EnableEeprom
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_EEPROM_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2002, "F"
endif
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl2_4",hostCPU,resTblId)
wait 5
...
local loopCount=0
local dumpFileName = "cpu1_eerestbl2_5"
...
while (keepDumpingResults = TRUE) do
  ...
  for i = 0 to CS_MAX_NUM_EEPROM_TABLE_ENTRIES-1 DO
    ...
    if (p@SCX_CPU1_CS_EEPROM_RESULT_TABLE[i].ComputedYet = "TRUE") AND ;;
       (SCX_CPU1_CS_EEPROM_RESULT_TABLE[i].BaselineCRC <> 0) AND ;;
...
for i = 0 to CS_MAX_NUM_EEPROM_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_EEPROM_RESULT_TABLE[i].State = "Enabled") AND (foundSeg = FALSE) then
    segIndex = i
    foundSeg = TRUE
  endif
enddo
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_DISABLE_EEPROM_ENTRY_INF_EID,"INFO",1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Disable Entry Command
/SCX_CPU1_CS_DisableEepromEntry EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_EEPROM_ENTRY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2005, "F"
endif
...
s get_tbl_to_cvt (ramDir,eeDefTblName,"A","cpu1_eedeftbl2_6",hostCPU,defTblId)
wait 5

if (p@SCX_CPU1_CS_EEPROM_DEF_TABLE[segindex].State = "Disabled") then
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl2_7",hostCPU,resTblId)
wait 5
...
/SCX_CPU1_TST_CS_CorruptMemCRC MemType=TST_CS_EEPROM_MEM EntryID=segIndex
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_ENABLE_EEPROM_ENTRY_INF_EID,"INFO", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_EEPROM_MISCOMPARE_ERR_EID,"ERROR", 2

write "*** Eeprom Segment Miscompare Ctr = ",SCX_CPU1_CS_EepromEC
LOCAL savedEEPROMEC = SCX_CPU1_CS_EepromEC

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable Entry Command
/SCX_CPU1_CS_EnableEepromEntry EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_EEPROM_ENTRY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2004, "F"
endif

;; Check that the Table miscompare counter incremented
;ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1, 120
;if (UT_TW_Status = UT_Success) then
wait 5
if (savedEEPROMEC != SCX_CPU1_CS_EepromEC) then
  write "<*> Passed (2001.1) - Expected Event Msg ",CS_EEPROM_MISCOMPARE_ERR_EID," rcv'd."
  ut_setrequirements CS_20011, "P"
else
  write "<!> Failed (2001.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_EEPROM_MISCOMPARE_ERR_EID,"."
  ut_setrequirements CS_20011, "F"
endif

write "*** Eeprom Miscompare Ctr = ",SCX_CPU1_CS_EepromEC
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl2_10",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_EEPROM_STARTED_DBG_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"INFO", 2

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Recompute Entry Command
/SCX_CPU1_CS_RecomputeEeprom EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2006) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_EEPROM_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2006, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_EEPROM_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the ReportEeprom Command
/SCX_CPU1_CS_ReportEeprom EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_EEPROM_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2007, "F"
endif
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl2_13",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_GET_ENTRY_ID_EEPROM_INF_EID,"INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Get EEPROM ID Command
/SCX_CPU1_CS_GetEepromEntryID Address=SCX_CPU1_CS_EEPROM_RESULT_TABLE[1].StartAddr
...
if (SCX_CPU1_find_event[1].num_found_messages > 0) then
  ...
  write "<!> Failed (1003;2008) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_GET_ENTRY_ID_EEPROM_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2008, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_EEPROM_INVALID_ENTRY_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Enable Entry Command
/SCX_CPU1_CS_EnableEepromEntry EntryID=CS_MAX_NUM_EEPROM_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;2009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_EEPROM_INVALID_ENTRY_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_2009, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_EEPROM_INVALID_ENTRY_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Disable Entry Command
/SCX_CPU1_CS_DisableEepromEntry EntryID=CS_MAX_NUM_EEPROM_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;2009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_EEPROM_INVALID_ENTRY_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_2009, "F"
endif
...
write ";  ID. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_INVALID_ENTRY_EEPROM_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Recompute Command
/SCX_CPU1_CS_RecomputeEeprom entryID=CS_MAX_NUM_EEPROM_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;4007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_INVALID_ENTRY_EEPROM_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_INVALID_ENTRY_EEPROM_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Report EEPROM Command
/SCX_CPU1_CS_ReportEeprom entryID=CS_MAX_NUM_EEPROM_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;2009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_INVALID_ENTRY_EEPROM_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_2009, "F"
endif
...
write ";  address. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_GET_ENTRY_ID_EEPROM_NOT_FOUND_INF_EID, "INFO", 1

local foundType=FALSE

for i = 1 to MEM_TABLE_SIZE DO
  if (p@SCX_CPU1_TST_CS_MemType[i] = "RAM") AND (foundType = FALSE) then
    ramAddress = SCX_CPU1_TST_CS_StartAddr[i] + 16
    foundType = TRUE
  endif
enddo
...
/SCX_CPU1_CS_GetEepromEntryID Address=ramAddress
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;2009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_GET_ENTRY_ID_EEPROM_NOT_FOUND_INF_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_2009, "F"
endif
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl3_13",hostCPU,resTblId)
wait 5
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeEeprom EntryID=1
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_EEPROM_CHDTASK_ERR_EID,"ERROR", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"INFO", 2

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeEeprom EntryID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_EEPROM_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1003, "F"
endif
...
ut_tlmwait  SCX_CPU1_find_event[2].num_found_messages, 1, 180
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2006.2) - Recompute Finished Event msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID," rcv'd."
  ut_setrequirements CS_20062, "P"
else
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_1",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_5",hostCPU,resTblId)
wait 5
...
for i = 0 to CS_MAX_NUM_EEPROM_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_EEPROM_RESULT_TABLE[i].State = "Disabled") AND (foundSeg = FALSE) then
    segIndex = i
    foundSeg = TRUE
  endif
enddo
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_10",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_16",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_21",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_28",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_33",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_39",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl4_44",hostCPU,resTblId)
wait 5
...
ut_tlmwait SCX_CPU1_find_event[3].num_found_messages, 1, 180
if (UT_TW_Status = UT_Success) then
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl5_6",hostCPU,resTblId)
wait 5
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_EEPROM_RANGE_ERR_EID,"ERROR", 3
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=eeDefTblName
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID, "ERROR", 2
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_EEPROM_STATE_ERR_EID,"ERROR", 3
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - EEPROM Definition Table validation event '", SCX_CPU1_find_event[2].eventid,"' found!"
else
  write "<!> Failed - EEPROM Definition Table validation event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_VALIDATION_INF_EID, "."
endif
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl5_15",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1","TST_CS",TST_CS_CORRUPT_EEPROM_MEM_INF_EID,"INFO", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_EEPROM_MISCOMPARE_ERR_EID,"ERROR", 2

;; Set the expected EEPROM Miscompare Counter before corrupting the memory
local eepromMiscompareCtr = SCX_CPU1_CS_EepromEC

/SCX_CPU1_TST_CS_CorruptEeprom
wait 5
...
if (SCX_CPU1_CS_EepromEC > eepromMiscompareCtr) then
...
;; This define is set to "/cf/cs_eepromtbl.tbl" in cs_platform_cfg.h
...
;; Download the table
s ftp_file ("CF:0",tableFileName,"cs_eeprom_orig_tbl.tbl",hostCPU,"G")
...
s get_tbl_to_cvt (ramDir,eeResTblName,"A","cpu1_eerestbl6_4",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
s ftp_file ("CF:0","cs_eeprom_orig_tbl.tbl",tableFileName,hostCPU,"P")
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_nvmem"
write ";*********************************************************************"
ENDPROC
