...
s create_tbl_file_from_cvt (hostCPU,defAppId,"App Definition Empty Table Load","appdefemptytable",appDefTblName,"SCX_CPU1_CS_APP_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_adt4                              "
write ";*********************************************************************"
ENDPROC
