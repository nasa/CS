...
write ";**********************************************************************"
;s ftp_file (ramDir,"app_def_tbl_ld_1","app_def_tbl_ld_1",hostCPU,"P")
;/SCX_CPU1_TBL_LOAD INACTIVE LTABLENAME=appDefTblName
...
if (SCX_CPU1_CS_CMDPC = 0) AND (SCX_CPU1_CS_CMDEC = 0) AND ;;
   ...
   (SCX_CPU1_CS_RecomputeInProgress = 0) AND ;;
   (SCX_CPU1_CS_OneShotInProgress = 0) AND ;;
...
write ";*********************************************************************"
s get_tbl_to_cvt (ramDir,appDefTblName,"A","cpu1_appdeftbl1_10",hostCPU,defAppId)
wait 5
...
if (p@SCX_CPU1_CS_TableState = "Enabled") then
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_APP_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Enable Apps Command
/SCX_CPU1_CS_EnableApps
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;4001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_APP_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_4001, "F"
endif
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl2_3",hostCPU,resAppId)
wait 5
...
while (keepDumpingResults = FALSE) do
  s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl2_4",hostCPU,resAppId)
  wait 3
  ...
  for i = 0 to CS_MAX_NUM_APP_TABLE_ENTRIES-1 DO
    ...
    if (p@SCX_CPU1_CS_APP_RESULT_TABLE[i].ComputedYet = "TRUE") AND ;;
       (SCX_CPU1_CS_APP_RESULT_TABLE[i].BaselineCRC <> 0) AND ;;
...
for i = 0 to CS_MAX_NUM_APP_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_APP_RESULT_TABLE[i].State = "Enabled") AND (foundApp = FALSE) then
    appIndex = i
    foundApp = TRUE
    break
  endif
...
if (foundApp = TRUE) then
  appName = SCX_CPU1_CS_APP_RESULT_TABLE[appIndex].NAME
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_DISABLE_APP_NAME_INF_EID,"INFO",1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Disable App Command
/SCX_CPU1_CS_DisableAppName AppName=appName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;4004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_APP_NAME_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_4004, "F"
endif

;; Dump the definition table to verify the entry's state was modified
s get_tbl_to_cvt (ramDir,appDefTblName,"A","cpu1_appdeftbl2_5",hostCPU,defAppId)
wait 5

if (p@SCX_CPU1_CS_APP_DEF_TABLE[appindex].State = "Disabled") then
...
/SCX_CPU1_TST_CS_CorruptAppCRC AppName=appName
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_APP_NAME_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_APP_MISCOMPARE_ERR_EID, "ERROR", 2

write "*** App Miscompare Ctr = ",SCX_CPU1_CS_AppEC

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable App Name Command
/SCX_CPU1_CS_EnableAppName AppName=appName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;4003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_APP_NAME_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_4003, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (4000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_APP_MISCOMPARE_ERR_EID,"."
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl2_8",hostCPU,resAppId)
wait 5
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_APP_INF_EID,"INFO", 2

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the RecomputeAppName Command
/SCX_CPU1_CS_RecomputeAppName AppName=appName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;4005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_APP_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_4005, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (4005.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_APP_INF_EID,"."
...
write ";  for the application specified in Step 2.5 above. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_APP_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the ReportAppName Command
/SCX_CPU1_CS_ReportAppName AppName=appName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;4006) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_APP_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_4006, "F"
endif
...
write ";*********************************************************************"
write ";  Step 2.11: Stop the CF_APP application. Verify that an event is    "
write ";  generated indicating the TST_TBL application was skipped."
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_COMPUTE_APP_NOT_FOUND_ERR_EID,"ERROR",1

/SCX_CPU1_ES_DELETEAPP Application="CF_APP"

ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1, 40
if (UT_TW_Status = UT_Success) then
;; Check for the event message
  write "<*> Passed (4000.2) - Expected Event Msg ",CS_COMPUTE_APP_NOT_FOUND_ERR_EID," rcv'd."
  ut_setrequirements CS_40002, "P"
else
  write "<!> Failed (4000.2) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_COMPUTE_APP_NOT_FOUND_ERR_EID,"."
  ut_setrequirements CS_40002, "F"
endif

write ";*********************************************************************"
write ";  Step 2.12: Start the CF_APP application. Verify that checksumming  "
write ";  is again occuring on the TST_TBL application."
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1

s load_start_app ("CF_APP",hostCPU,"CF_AppMain")
                                                                                
; Wait for app startup events
ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1
IF (UT_TW_Status = UT_Success) THEN
    write "<*> Passed - CF_APP Application Started"
else
  write "<!> Failed - CFE_ES start Event Message for CF_APP not received."
  write "Event Message count = ",SCX_CPU1_find_event[1].num_found_messages
endif
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the RecomputeAppName Command
/SCX_CPU1_CS_RecomputeAppName AppName="CF_APP"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_APP_UNKNOWN_NAME_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the EnableAppName Command
/SCX_CPU1_CS_EnableAppName AppName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;4007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_APP_UNKNOWN_NAME_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_4007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the EnableAppName Command
/SCX_CPU1_CS_EnableAppName AppName="CS_TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_APP_UNKNOWN_NAME_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the DisableAppName Command
/SCX_CPU1_CS_DisableAppName AppName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;4007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_APP_UNKNOWN_NAME_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_4007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the DisableAppName Command
/SCX_CPU1_CS_DisableAppName AppName="CS_TST"
...
;; CPU1 is the default
rawcmd = "189Fc000001624994353000000000000000000000000000000000000"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_UNKNOWN_NAME_APP_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the RecomputeAppName Command
/SCX_CPU1_CS_RecomputeAppName AppName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;4007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_UNKNOWN_NAME_APP_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_4007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the RecomputeAppName Command
/SCX_CPU1_CS_RecomputeAppName AppName="CS_TST"
...
;; CPU1 is the default
rawcmd = "189Fc000002624984353000000000000000000000000000000000000"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_INVALID_NAME_APP_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the ReportAppName Command
/SCX_CPU1_CS_ReportAppName AppName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;4007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_INVALID_NAME_APP_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_4007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the ReportAppName Command
/SCX_CPU1_CS_ReportAppName AppName="CS_TST"
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl3_11",hostCPU,resAppId)
wait 5
...
;; Verify the telemetry flag is set to TRUE (4005)
;ut_tlmwait SCX_CPU1_CS_RecomputeInProgress, 1
;if (UT_TW_Status = UT_Success) then
;  write "<*> Passed (4005) - In Progress Flag set to True as expected."
;  ut_setrequirements CS_4005, "P"
;else
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_APP_CHDTASK_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the RecomputeAppName Command
/SCX_CPU1_CS_RecomputeAppName AppName=CSAppName

ut_tlmwait SCX_CPU1_CS_CMDEC, {errcnt}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (1004;4005.2) - CS RecomputeAppName rejected as expected since one is already running."
  ut_setrequirements CS_1004, "P"
  ut_setrequirements CS_40052, "P"
else
  write "<!> Failed (1004;4005.2) - CS RecomputeAppName command did not increment CMDEC as expected."
  ut_setrequirements CS_1004, "F"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_APP_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
for i = 0 to CS_MAX_NUM_APP_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_APP_RESULT_TABLE[i].State = "Disabled") AND (foundApp = FALSE) then
    appIndex = i
    foundApp = TRUE
  endif
enddo
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_4",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_8",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_13",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_17",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_23",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_27",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_32",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl4_36",hostCPU,resAppId)
wait 5
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl5_6",hostCPU,resAppId)
wait 5
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=appDefTblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - Application Definition Table validation event '", SCX_CPU1_find_event[2].eventid,"' found!"
else
  write "<!> Failed - Application Definition Table validation event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_LOAD_PEND_REQ_INF_EID, "."
endif
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl5_14",hostCPU,resAppId)
wait 5
...
if (p@SCX_CPU1_CS_EepromState = "Enabled") then
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_EEPROM_INF_EID,"."
  endif
else
...
if (p@SCX_CPU1_CS_OSState = "Enabled") then
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_OS_INF_EID,"."
  endif
else
...
if (p@SCX_CPU1_CS_CFECoreState = "Enabled") then
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_CFECORE_INF_EID,"."
  endif
else
...
if (p@SCX_CPU1_CS_TableState = "Enabled") then
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_TABLES_INF_EID,"."
  endif
else
...
if (p@SCX_CPU1_CS_MemoryState = "Enabled") then
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_MEMORY_INF_EID,"."
  endif
else
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl6_6",hostCPU,resAppId)
wait 5
...
while (keepDumpingResults = FALSE) do
  s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl6_7",hostCPU,resAppId)
  wait 3

  ;; Loop for each valid entry in the results table
  for i = 0 to CS_MAX_NUM_APP_TABLE_ENTRIES-1 DO
    ;; If the entry is valid and the Offset or tempCRC are not zero -> Stop
    if (p@SCX_CPU1_CS_APP_RESULT_TABLE[i].State <> "Empty") AND ;;
       (SCX_CPU1_CS_APP_RESULT_TABLE[i].ByteOffset <> 0) OR ;;
       (SCX_CPU1_CS_APP_RESULT_TABLE[i].TempCRC <> 0) AND ;;
       (keepDumpingResults = FALSE) then
      keepDumpingResults = TRUE
      segmentedCRC = TRUE
    endif
...
s ftp_file ("CF:0",tableFileName,"cs_apptbl.tblORIG",hostCPU,"G")
wait 5

write ";*********************************************************************"
write ";  Step 7.3: Delete the Application Code Segment Definition table "
write ";  default load file from the CPU1. "
write ";*********************************************************************"
...
write ";*********************************************************************"
;s scx_cpu1_cs_start_apps("7.4")
ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_INIT_INF_EID, "INFO", 2
...
s get_tbl_to_cvt (ramDir,appResTblName,"A","cpu1_apprestbl7_5",hostCPU,resAppId)
wait 5
...
write ";*********************************************************************"
s ftp_file ("CF:0","cs_apptbl.tblORIG",tableFileName,hostCPU,"P")
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_appcode                                  "
write ";*********************************************************************"
ENDPROC
