...
;; Set the CS HK packet ID based upon the cpu being used
hkPktId = "p0A4"
...
;; Check the HK State 
if (p@scx_cpu1_CS_State = "Enabled") then
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_OS_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Enable OS Command
/SCX_CPU1_CS_EnableOS
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_OS_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3002, "F"
endif
...
if (SCX_CPU1_CS_OSBASELINE <> 0) then
...
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_OS_MISCOMPARE_ERR_EID, "ERROR", 1

;; Wait for the OS Miscompare event message
ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1, 300
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3000.1) - Expected Event Msg ",CS_OS_MISCOMPARE_ERR_EID," rcv'd."
  ut_setrequirements CS_30001, "P"
else
  write "<!> Failed (3000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_OS_MISCOMPARE_ERR_EID,"."
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_OS_STARTED_DBG_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID, "INFO", 2

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeOS
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_OS_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3004, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (3004.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"."
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_OS_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the ReportOS Command
/SCX_CPU1_CS_ReportOS
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_OS_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3005, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_CFECORE_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Enable cFE Core Command
/SCX_CPU1_CS_EnableCFECore
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_CFECORE_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3007, "F"
endif
...
while (waitForCFECRC = TRUE) do
  if (SCX_CPU1_CS_CFECOREBASELINE <> 0) then
    waitForCFECRC = FALSE
  else
    wait 10
  endif
...
write ";*********************************************************************"
;; Send a TST_CS command to do this using tblName as the argument
ut_setupevents "SCX", "CPU1", "TST_CS", TST_CS_CORRUPT_CFE_CRC_INF_EID, "INFO", 1
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_CFECORE_MISCOMPARE_ERR_EID,"ERROR", 1

;; Check for the event message
ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1, 200
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3006.1) - Expected Event Msg ",CS_OS_MISCOMPARE_ERR_EID," rcv'd."
  ut_setrequirements CS_30061, "P"
else
  write "<!> Failed (3006.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_OS_MISCOMPARE_ERR_EID,"."
...
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_CFECORE_STARTED_DBG_EID, "DEBUG", 1
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID, "INFO", 2

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeCFECore
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_CFECORE_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3009, "F"
endif
...
;; Check for the event message #2
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1, 230
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3009.1) - Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID," rcv'd."
  ut_setrequirements CS_30091, "P"
else
  write "<!> Failed (1003;3009.1) - RecomputeCFECore failed to complete in the time allowed. Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"."
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_BASELINE_CFECORE_INF_EID,"INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the ReportCFECore Command
/SCX_CPU1_CS_ReportCFECore
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_CFECORE_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3010, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_OS_CHDTASK_ERR_EID,"ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_OS_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
write ";  command should fail since there is already a recompute active.     "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_CFECORE_CHDTASK_ERR_EID, "ERROR", 1
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID, "INFO", 2
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_CFECORE_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3009) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_OS_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3009, "F"
endif
...
;; Check the HK State 
if (p@scx_cpu1_CS_State = "Disabled") then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3004.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"."
  ut_setrequirements CS_30041, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3009.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"."
  ut_setrequirements CS_30091, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (3009.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"."
  ut_setrequirements CS_30091, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_corecode"
write ";*********************************************************************"
ENDPROC
