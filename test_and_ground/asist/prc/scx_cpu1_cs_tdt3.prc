...
SCX_CPU1_CS_TBL_DEF_TABLE[0].Name = tblDefTblName
...
SCX_CPU1_CS_TBL_DEF_TABLE[2].Name = tblResTblName
...
SCX_CPU1_CS_TBL_DEF_TABLE[6].Name = CSAppName & "." & CS_DEF_APP_TABLE_NAME
...
SCX_CPU1_CS_TBL_DEF_TABLE[8].Name = CSAppName & "." & CS_RESULTS_APP_TABLE_NAME
SCX_CPU1_CS_TBL_DEF_TABLE[9].State = CS_STATE_EMPTY
SCX_CPU1_CS_TBL_DEF_TABLE[9].Name = ""
SCX_CPU1_CS_TBL_DEF_TABLE[10].State = 7
SCX_CPU1_CS_TBL_DEF_TABLE[10].Name = "IN_VALID_Table"
...
s create_tbl_file_from_cvt (hostCPU,defTblId,"Table Definition Table Invalid State","tbl_def_tbl_invalid",tblDefTblName,"SCX_CPU1_CS_TBL_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_tdt3                              "
write ";*********************************************************************"
ENDPROC
