...
SCX_CPU1_CS_APP_DEF_TABLE[4].State = CS_STATE_DISABLED
...
s create_tbl_file_from_cvt (hostCPU,defAppId,"App Definition Table Load 2","app_def_tbl_ld_2",appDefTblName,"SCX_CPU1_CS_APP_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_adt2                              "
write ";*********************************************************************"
ENDPROC
