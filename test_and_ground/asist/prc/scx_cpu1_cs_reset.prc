...
s ftp_file ("CF:0",appTableFileName,"cs_app_orig_tbl.tbl",hostCPU,"G")
...
;; Get the file in order to restore it in the cleanup steps
s ftp_file ("CF:0",tblTableFileName,"cs_tbl_orig_tbl.tbl",hostCPU,"G")
...
;; Get the file in order to restore it in the cleanup steps
s ftp_file ("CF:0",eeTableFileName,"cs_eeprom_orig_tbl.tbl",hostCPU,"G")
...
;; Get the file in order to restore it in the cleanup steps
s ftp_file ("CF:0",memTableFileName,"cs_mem_orig_tbl.tbl",hostCPU,"G")
...
s ftp_file ("CF:0","eeprom_def_ld_1",eeTableFileName,hostCPU,"P")
wait 10
...
s ftp_file ("CF:0","app_def_tbl_ld_1",appTableFileName,hostCPU,"P")
wait 10
...
s ftp_file ("CF:0","tbl_def_tbl_ld_3",tblTableFileName,hostCPU,"P")
wait 10
...
;; Upload the file created above as the default 
s ftp_file ("CF:0","usrmem_def_ld_3",memTableFileName,hostCPU,"P")
wait 10
...
;wait 5
; NOTE: Restarting the apps to use table changes made above
...
write ";********************************************************************"
; NOTE: commented out because these apps are in the startup script
...
write ";********************************************************************"
; NOTE: commented out because these apps are in the startup script
;s scx_cpu1_cs_start_apps("3.27.5")
...
write ";********************************************************************"
;; Check the OS State
if (p@SCX_CPU1_CS_OSState = expOSState) then
...
if (p@SCX_CPU1_CS_CFECoreState = expCFEState) then
...
if (p@SCX_CPU1_CS_EepromState = expEepromState) then
...
if (p@SCX_CPU1_CS_MemoryState = expMemoryState) then
...
if (p@SCX_CPU1_CS_AppState = expAppState) then
...
if (p@SCX_CPU1_CS_TableState = expTableState) then
...
write ";********************************************************************"
local nextPass = SCX_CPU1_CS_PASSCTR + 2
ut_tlmwait SCX_CPU1_CS_PASSCTR, {nextPass}, 700
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_CFECORE_MISCOMPARE_ERR_EID,"ERROR", 2
...
;; Use the TST_CS app to corrupt the OS and cFE CRCs
ut_setupevents "SCX","CPU1","TST_CS",TST_CS_CORRUPT_OS_CRC_INF_EID, "INFO", 3
ut_setupevents "SCX","CPU1",{CSAppName},CS_OS_MISCOMPARE_ERR_EID, "ERROR", 4
...
;ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_STOP_INF_EID, "INFO", 1
...
write ";  preserved after an Application Reset. "
write ";*********************************************************************"
...
write ";********************************************************************"
;s scx_cpu1_cs_start_apps("4.23.3")
...
write ";*********************************************************************"
s ftp_file ("CF:0","eeprom_def_invalid",eeTableFileName,hostCPU,"P")
wait 5
...
write ";*********************************************************************"
s ftp_file ("CF:0","app_def_tbl_invalid",appTableFileName,hostCPU,"P")
...
write ";*********************************************************************"
s ftp_file ("CF:0","tbl_def_tbl_invalid",tblTableFileName,hostCPU,"P")
...
write ";*********************************************************************"
s ftp_file ("CF:0","usrmem_def_invalid",memTableFileName,hostCPU,"P")
...
;ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_MEMORY_RANGE_ERR_EID, "ERROR", 4
;ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_TABLES_STATE_ERR_EID, "ERROR", 5
;ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_APP_STATE_ERR_EID, "ERROR", 6
;s scx_cpu1_cs_start_apps("5.11")
...
;;         rather than 'A'
;; 8/11/21: These events cannot be captured since the CS app is started in
;;          the startup script. The requirements are set to "A"
write ";*********************************************************************"
...
write ";*********************************************************************"
s ftp_file ("CF:0","eeprom_bad_state",eeTableFileName,hostCPU,"P")
wait 5
...
write ";*********************************************************************"
s ftp_file ("CF:0","usrmem_def_invalid3",memTableFileName,hostCPU,"P")
wait 10
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_MEMORY_STATE_ERR_EID, "ERROR", 4
...
write ";*********************************************************************"
s ftp_file ("CF:0","cs_mem_orig_tbl.tbl",memTableFileName,hostCPU,"P")
s ftp_file ("CF:0","cs_app_orig_tbl.tbl",appTableFileName,hostCPU,"P")
s ftp_file ("CF:0","cs_tbl_orig_tbl.tbl",tblTableFileName,hostCPU,"P")
s ftp_file ("CF:0","cs_eeprom_orig_tbl.tbl",eeTableFileName,hostCPU,"P")
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_reset"
write ";*********************************************************************"
ENDPROC
