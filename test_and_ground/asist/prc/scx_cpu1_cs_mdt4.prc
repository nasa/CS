...
s create_tbl_file_from_cvt (hostCPU,defTblId,"Memory Definition Empty Table Load","usrmemdefemptytbl",memDefTblName,"SCX_CPU1_CS_MEM_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure scx_cpu1_cs_mdt4                              "
write ";*********************************************************************"
ENDPROC
