...
SCX_CPU1_CS_MEM_DEF_TABLE[0].State = 1
SCX_CPU1_CS_MEM_DEF_TABLE[0].StartAddr = SCX_CPU1_TST_CS_StartAddr[ramEntry]
SCX_CPU1_CS_MEM_DEF_TABLE[1].State = 0
SCX_CPU1_CS_MEM_DEF_TABLE[1].StartAddr = 0
SCX_CPU1_CS_MEM_DEF_TABLE[1].NumBytes = 0
SCX_CPU1_CS_MEM_DEF_TABLE[2].State = 2
SCX_CPU1_CS_MEM_DEF_TABLE[2].StartAddr = SCX_CPU1_TST_CS_StartAddr[ramEntry]+ramQuarterSize
SCX_CPU1_CS_MEM_DEF_TABLE[2].NumBytes = ramHalfSize
SCX_CPU1_CS_MEM_DEF_TABLE[3].State = 0
SCX_CPU1_CS_MEM_DEF_TABLE[3].StartAddr = 0
SCX_CPU1_CS_MEM_DEF_TABLE[3].NumBytes = 0
SCX_CPU1_CS_MEM_DEF_TABLE[4].State = 1
SCX_CPU1_CS_MEM_DEF_TABLE[4].StartAddr = SCX_CPU1_TST_CS_StartAddr[ramEntry]+ramHalfSize
SCX_CPU1_CS_MEM_DEF_TABLE[5].State = 0
SCX_CPU1_CS_MEM_DEF_TABLE[5].StartAddr = 0
SCX_CPU1_CS_MEM_DEF_TABLE[5].NumBytes = 0
SCX_CPU1_CS_MEM_DEF_TABLE[6].State = 1
SCX_CPU1_CS_MEM_DEF_TABLE[6].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]
SCX_CPU1_CS_MEM_DEF_TABLE[7].State = 2
SCX_CPU1_CS_MEM_DEF_TABLE[7].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]+eeQuarterSize
SCX_CPU1_CS_MEM_DEF_TABLE[7].NumBytes = eeHalfSize
...
if (ramQuarterSize > 4096) then
  ...
  SCX_CPU1_CS_MEM_DEF_TABLE[4].NumBytes = 4096
else
  SCX_CPU1_CS_MEM_DEF_TABLE[0].NumBytes = ramQuarterSize
  SCX_CPU1_CS_MEM_DEF_TABLE[4].NumBytes = ramQuarterSize
endif
...
s create_tbl_file_from_cvt (hostCPU,defTblId,"User-defined Memory Definition Table Valid Load 2","usrmem_def_ld_2",memDefTblName,"SCX_CPU1_CS_MEM_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure scx_cpu1_cs_mdt3                              "
write ";*********************************************************************"
ENDPROC
