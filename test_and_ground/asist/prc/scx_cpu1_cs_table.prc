...
s ftp_file ("CF:0",tableFileName,"cs_tablesorig.tbl",hostCPU,"G")
wait 5
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_INF_EID,"INFO", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO", 2

local cmdCtr = SCX_CPU1_TBL_CMDPC + 1

/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=tblDefTblName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_VALIDATION_INF_EID, "."
endif

cmdCtr = SCX_CPU1_TBL_CMDPC + 1

/SCX_CPU1_TBL_ACTIVATE ATableName=tblDefTblName
...
write ";**********************************************************************"
write ";  Step 1.7: Start the LC Application (LC).          "
write ";**********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", "LC", LC_INIT_INF_EID, "INFO", 2
...
/SCX_CPU1_EVS_EnaAppEVTType Application=CSAppName DEBUG
wait 2
...
write ";*********************************************************************"
s get_tbl_to_cvt (ramDir,tblDefTblName,"A","cpu1_deftbl1_10",hostCPU,defTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_ALL_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable All Command
/SCX_CPU1_CS_EnableAll

ut_tlmwait SCX_CPU1_CS_CMDPC, {cmdCtr}
if (UT_TW_Status = UT_Success) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;8000) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_ALL_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_8000, "F"
endif

;; Send the Disable OS Checksumming Command
/SCX_CPU1_CS_DisableOS
wait 1

;; Send the Disable CFE Core Checksumming Command
/SCX_CPU1_CS_DisableCFECore
wait 1

;; Disable Eeprom Checksumming if it is enabled
if (p@SCX_CPU1_CS_EepromState = "Enabled") then
  /SCX_CPU1_CS_DisableEeprom
  wait 1
endif

;; Disable User-defined Memory Checksumming if it is enabled
if (p@SCX_CPU1_CS_MemoryState = "Enabled") then
  /SCX_CPU1_CS_DisableMemory
  wait 1
endif

;; Disable Application Checksumming if it is enabled
if (p@SCX_CPU1_CS_AppState = "Enabled") then
  /SCX_CPU1_CS_DisableApps
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_TABLES_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Enable Tables Command
/SCX_CPU1_CS_EnableTables
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_TABLES_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_5001, "F"
endif
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl2_3",hostCPU,resTblId)
wait 5
...
local dumpFileName = "cpu1_tblrestbl2_4"
...
while (keepDumpingResults = TRUE) do
  ...
  for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
    ...
    if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].ComputedYet = "TRUE") AND ;;
       (SCX_CPU1_CS_TBL_RESULT_TABLE[i].BaselineCRC <> 0) AND ;;
...
for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].State = "Enabled") AND ;;
     (SCX_CPU1_CS_TBL_RESULT_TABLE[i].Name <> tblDefTblName) AND ;;
     (foundTbl = FALSE) then
    tblIndex = i
    foundTbl = TRUE
  endif
...
if (foundTbl = TRUE) then
  tblName = SCX_CPU1_CS_TBL_RESULT_TABLE[tblIndex].NAME
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_DISABLE_TABLES_NAME_INF_EID,"INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Disable Table Command
/SCX_CPU1_CS_DisableTableName TableName=tblName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_TABLES_NAME_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_5004, "F"
endif
...
s get_tbl_to_cvt (ramDir,tblDefTblName,"A","cpu1_deftbl2_5",hostCPU,defTblId)
wait 5

if (p@SCX_CPU1_CS_TBL_DEF_TABLE[tblindex].State = "Disabled") then
...
/SCX_CPU1_TST_CS_CorruptTblCRC TableName=tblName
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_ENABLE_TABLES_NAME_INF_EID,"INFO", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_TABLES_MISCOMPARE_ERR_EID,"ERROR", 2

write "*** Table Miscompare Ctr = ",SCX_CPU1_CS_TableEC

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable Table Name Command
/SCX_CPU1_CS_EnableTableName TableName=tblName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_TABLES_NAME_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_5003, "F"
endif

;; Check that the Table miscompare event message was rcvd
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1, 60
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (5000.1) - Expected Event Msg ",CS_TABLES_MISCOMPARE_ERR_EID," rcv'd."
  ut_setrequirements CS_50001, "P"
else
  write "<!> Failed (5000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_TABLES_MISCOMPARE_ERR_EID,"."
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl2_8",hostCPU,resTblId)
wait 5
...
/SCX_CPU1_CS_RecomputeTableName TableName=tblName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_TABLES_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_5005, "F"
endif
...
write ";  in Step 2.5 above. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_TABLES_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the ReportTableName Command
/SCX_CPU1_CS_ReportTableName TableName=tblName
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5006) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_TABLES_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_5006, "F"
endif
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","c1_tblrestbl2111",hostCPU,resTblId)
wait 5
...
for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
  if (SCX_CPU1_CS_TBL_RESULT_TABLE[i].Name = appDefTblName) then
    appDefCRC = SCX_CPU1_CS_TBL_RESULT_TABLE[i].BaselineCRC
    appDefIndex = i
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_FILE_LOADED_INF_EID, "."
endif
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=appDefTblName
...
/SCX_CPU1_TBL_ACTIVATE ATableName=appDefTblName
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","c1_tblrestbl2112",hostCPU,resTblId)
wait 5

;; Verify that the table's CRC has been recalculated
if (SCX_CPU1_CS_TBL_RESULT_TABLE[appDefIndex].BaselineCRC <> appDefCRC) then
...
write ";*********************************************************************"
write ";  Step 2.12: Stop the LC application. Verify that an event is    "
write ";  generated indicating the LC tables were skipped."
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_COMPUTE_TABLES_NOT_FOUND_ERR_EID,"ERROR", 1

/SCX_CPU1_ES_DELETEAPP Application="LC"
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (5000.3) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_COMPUTE_TABLES_NOT_FOUND_ERR_EID,"."
  ut_setrequirements CS_50003, "F"
endif

write ";*********************************************************************"
write ";  Step 2.13: Start the LC application. Verify that checksumming  "
write ";  is again occuring on the LC.dflt_tbl_01 table."
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", "LC", LC_INIT_INF_EID, "INFO", 2
...
write "Skipping Step 2.14 since TST_TBL is not available for testing"
goto step2_26
write ";*********************************************************************"
write ";  Step 2.14: Using the TST_TBL application, register 2 new tables. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "TST_TBL", TST_TBL_TBLREGISTERPASS_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", "TST_TBL", TST_TBL_TBLREGISTER_EID, "INFO", 2

/SCX_CPU1_TST_TBL_TBLREGISTER RTABLENAME="tableA" TBLOPTS=X'0' TBLSIZE=X'28'
wait 5
/SCX_CPU1_TST_TBL_TBLREGISTER RTABLENAME="tableB" TBLOPTS=X'0' TBLSIZE=X'28'
wait 5
...
IF (UT_TW_Status = UT_Success) THEN
  ...
  write "<!> Failed - Table create command. Expected 2 events of ID", TST_TBL_TBLREGISTERPASS_EID, ". Rcv'd ",scx_cpu1_find_event[1].num_found_messages
endif
...
IF (UT_TW_Status = UT_Success) THEN
  ...
  write "<!> Failed - Table register command. Expected 2 events of ID",TST_TBL_TBLREGISTER_EID, ". Rcv'd ",scx_cpu1_find_event[2].num_found_messages
endif
...
SCX_CPU1_TST_TBL_TABLE1.element[1] = 1
SCX_CPU1_TST_TBL_TABLE1.element[2] = 2
SCX_CPU1_TST_TBL_TABLE1.element[3] = 3
SCX_CPU1_TST_TBL_TABLE1.element[4] = 4
SCX_CPU1_TST_TBL_TABLE1.element[5] = 5
SCX_CPU1_TST_TBL_TABLE1.element[6] = 6
SCX_CPU1_TST_TBL_TABLE1.element[7] = 7
SCX_CPU1_TST_TBL_TABLE1.element[8] = 8
SCX_CPU1_TST_TBL_TABLE1.element[9] = 9
SCX_CPU1_TST_TBL_TABLE1.element[10] = 10

;; Create the load file
s create_tbl_file_from_cvt (hostCPU,4002,"TableA initial load", "tst_tbl_a_ld","TST_TBL.tableA", "SCX_CPU1_TST_TBL_TABLE1.element[1]", "SCX_CPU1_TST_TBL_TABLE1.element[10]")

;; Initial tableB values
SCX_CPU1_TST_TBL_TABLE1.element[1] = 10
SCX_CPU1_TST_TBL_TABLE1.element[2] = 9
SCX_CPU1_TST_TBL_TABLE1.element[3] = 8
SCX_CPU1_TST_TBL_TABLE1.element[4] = 7
SCX_CPU1_TST_TBL_TABLE1.element[5] = 6
SCX_CPU1_TST_TBL_TABLE1.element[6] = 5
SCX_CPU1_TST_TBL_TABLE1.element[7] = 4
SCX_CPU1_TST_TBL_TABLE1.element[8] = 3
SCX_CPU1_TST_TBL_TABLE1.element[9] = 2
SCX_CPU1_TST_TBL_TABLE1.element[10] = 1

s create_tbl_file_from_cvt (hostCPU,4002,"TableB initial load", "tst_tbl_b_ld","TST_TBL.tableB", "SCX_CPU1_TST_TBL_TABLE1.element[1]", "SCX_CPU1_TST_TBL_TABLE1.element[10]")
...
/SCX_CPU1_TBL_ACTIVATE ATableName="TST_TBL.tableA"
/SCX_CPU1_TBL_ACTIVATE ATableName="TST_TBL.tableB"
...
cmdCtr = SCX_CPU1_CS_CMDPC + 2
;; Send the Enable Table Name Commands
/SCX_CPU1_CS_EnableTableName TableName="TST_TBL.tableA"
wait 2
/SCX_CPU1_CS_EnableTableName TableName="TST_TBL.tableB"
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl2_17",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents SCX, CPU1, TST_TBL, TST_TBL_UNREGSFREETBL_EID, INFO, 1
ut_setupevents SCX, CPU1, TST_TBL, TST_TBL_UNREGISTERTBL_EID, INFO, 2

/SCX_CPU1_TST_TBL_UNREGTBL UTABLENAME="tableA"
wait 10

/SCX_CPU1_TST_TBL_UNREGTBL UTABLENAME="tableB"
wait 10

;; Should have 2 messages found for each event
if (SCX_CPU1_find_event[1].num_found_messages = 2 AND SCX_CPU1_find_event[2].num_found_messages = 2) then
  write "<*> Passed - Expected Event Messages ",SCX_CPU1_find_event[1].eventid, " and ", SCX_CPU1_find_event[2].eventid, " received."
else
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl2_19",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl2_22",hostCPU,resTblId)
wait 5
...
/SCX_CPU1_TST_CS_CorruptTblCRC TableName="TST_TBL.tableA"
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - Event message ",SCX_CPU1_find_event[2].eventid, " received"
else
  write "<!> Failed - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_UPDATE_SUCCESS_INF_EID, "."
endif 
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl2_25",hostCPU,resTblId)
wait 5
...
for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
  if (SCX_CPU1_CS_TBL_RESULT_TABLE[i].Name = "TST_TBL.tableA") then
    if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].ComputedYet = "TRUE") AND ;;
       (SCX_CPU1_CS_TBL_RESULT_TABLE[i].BaselineCRC <> tableABadCRC) then
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_TABLES_STARTED_DBG_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_TABLES_INF_EID,"INFO", 2
ut_setupevents "SCX","CPU1",{CSAppName},CS_TABLES_MISCOMPARE_ERR_EID,"ERROR", 3

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Recompute Command
/SCX_CPU1_CS_RecomputeTableName TableName=tblDefTblName
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Recompute Command
/SCX_CPU1_CS_RecomputeTableName TableName=tblResTblName
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_LEN_ERR_EID, "ERROR", 1

local errcnt = SCX_CPU1_CS_CMDEC + 1

;; CPU1 is the default
rawcmd = "189Fc00000021c99"

ut_sendrawcmd "SCX_CPU1_CS", (rawcmd)

ut_tlmwait SCX_CPU1_CS_CMDEC, {errcnt}
if (UT_TW_Status = UT_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed (1004) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements CS_1004, "P"
else
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CS_LEN_ERR_EID, "."
  ut_setrequirements CS_1004, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_TABLES_UNKNOWN_NAME_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Enable Table Name Command
/SCX_CPU1_CS_EnableTableName TableName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;5007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_TABLES_UNKNOWN_NAME_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_5007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Enable Table Name Command
/SCX_CPU1_CS_EnableTableName TableName="CS_TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_TABLES_UNKNOWN_NAME_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Disable Table Name Command
/SCX_CPU1_CS_DisableTableName TableName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;5007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_TABLES_UNKNOWN_NAME_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_5007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Disable Table Name Command
/SCX_CPU1_CS_DisableTableName TableName="CS_TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_INVALID_NAME_TABLES_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Report Table Name Command
/SCX_CPU1_CS_ReportTableName TableName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;5007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_INVALID_NAME_TABLES_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_5007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Report Table Name Command
/SCX_CPU1_CS_ReportTableName TableName="CS_TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_UNKNOWN_NAME_TABLES_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Recompute Command
/SCX_CPU1_CS_RecomputeTableName TableName=""
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;5007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_UNKNOWN_NAME_TABLES_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_5007, "F"
endif
...
errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Recompute Command
/SCX_CPU1_CS_RecomputeTableName TableName="CS_TST"
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_TABLES_CHDTASK_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeTableName TableName="LC.LC_ADT"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;5005.2) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_TABLES_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_50052, "F"
endif
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_ONESHOT_CHDTASK_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the One Shot Command
/SCX_CPU1_CS_OneShot Address=SCX_CPU1_TST_CS_StartAddr[1] RegionSize=2048 MaxBytes=2048
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;5005.2) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ONESHOT_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_50052, "F"
endif
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl3_13",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_ALL_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Disable All Command
/SCX_CPU1_CS_DisableAll
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;8001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_ALL_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_8001, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_TABLES_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Disable Tables Command
/SCX_CPU1_CS_DisableTables
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_TABLES_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_5002, "F"
endif
...
for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].State = "Disabled") AND (foundTbl = FALSE) then
    tblIndex = i
    foundTbl = TRUE
  endif
enddo
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_4",hostCPU,resTblId)
wait 5
...
if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[tblIndex].ComputedYet = "FALSE") then
  ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_TABLES_STARTED_DBG_EID,"DEBUG", 1
  ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_TABLES_INF_EID,"INFO", 2
...
for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].State = "Enabled") AND (foundTbl = FALSE) then
    tblIndex = i
    foundTbl = TRUE
  endif
enddo
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_8",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_12",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_15",hostCPU,resTblId)
wait 5
...
local cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable All Command
/SCX_CPU1_CS_EnableAll
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_20",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_24",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_28",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl4_31",hostCPU,resTblId)
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CFE_TBL_FILE_LOADED_INF_EID,"."
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CFE_TBL_VALIDATION_INF_EID,"."
endif
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl5_5",hostCPU,resTblId)
wait 5
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=tblDefTblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - Table Definition Table validation event '", SCX_CPU1_find_event[2].eventid,"' found!"
else
  write "<!> Failed - Table Definition Table validation event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_LOAD_PEND_REQ_INF_EID, "."
endif
...
s get_tbl_to_cvt (ramDir,tblDefTblName,"A","cpu1_deftbl5_13",hostCPU,defTblId)
wait 5

;; Dump the Definition Table
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl5_13",hostCPU,resTblId)
wait 5
...
write ";  command. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_EEPROM_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_EEPROM_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_2003, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_OS_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_OS_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3003, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_CFECORE_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;3008) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_CFECORE_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_3008, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_APP_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;4002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_APP_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_4002, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_MEMORY_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_MEMORY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6002, "F"
endif
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl6_6",hostCPU,resTblId)
wait 5
...
for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
  ...
  if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].State = "Enabled") then
    if (largestSize < SCX_CPU1_CS_TBL_RESULT_TABLE[i].NumBytes) then
      largestSize = SCX_CPU1_CS_TBL_RESULT_TABLE[i].NumBytes
    endif
  endif
enddo
...
ut_setupevents "SCX","CPU1","TST_CS",TST_CS_SET_BYTES_PER_CYCLE_INF_EID,"INFO",1

;; Send the command to set the bytes
/SCX_CPU1_TST_CS_SetMaxBytes numBytes=halfSize
wait 5
...
while (keepDumpingResults = FALSE) do
  s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl6_8",hostCPU,resTblId)
  wait 3

  ;; Loop for each valid entry in the results table
  for i = 0 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 DO
    ;; If the entry is valid and the Offset or tempCRC are not zero -> Stop
    if (p@SCX_CPU1_CS_TBL_RESULT_TABLE[i].State <> "Empty") AND ;;
       (SCX_CPU1_CS_TBL_RESULT_TABLE[i].ByteOffset <> 0) OR ;;
       (SCX_CPU1_CS_TBL_RESULT_TABLE[i].TempCRC <> 0) AND ;;
...
write ";  CPU1. "
write ";*********************************************************************"
s ftp_file ("CF:0","na",tableFileName,hostCPU,"R")

write ";*********************************************************************"
write ";  Step 7.3: Start the CS Application. "
write ";*********************************************************************"
;s scx_cpu1_cs_start_apps("7.3")
/SCX_CPU1_ES_RestartAPP Application="TST_CS"
wait 5
/SCX_CPU1_ES_RestartAPP Application=CSAppName
wait 5
...
s get_tbl_to_cvt (ramDir,tblResTblName,"A","cpu1_tblrestbl7_4",hostCPU,resTblId)
wait 5
...
write ";       step 1.1. "
write ";*********************************************************************"
s ftp_file ("CF:0","cs_tablestbl.tblORIG",tableFileName,hostCPU,"P")
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_table"
write ";*********************************************************************"
ENDPROC
