...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=memDefTblName
...
/SCX_CPU1_TBL_ACTIVATE ATableName=memDefTblName
...
write ";*********************************************************************"
s get_tbl_to_cvt (ramDir,memDefTblName,"A","cpu1_usrdeftbl1_9",hostCPU,defTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl2_1",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_MEMORY_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1

;; Send the Enable Memory Command
/SCX_CPU1_CS_EnableMemory
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_MEMORY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6001, "F"
endif
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl2_4",hostCPU,resTblId)
wait 5
...
local loopCount=0
local dumpFileName = "cpu1_usrrestbl2_5"
...
while (keepDumpingResults = TRUE) do
  ...
  for i = 0 to CS_MAX_NUM_MEMORY_TABLE_ENTRIES-1 DO
    ...
    if (p@SCX_CPU1_CS_MEM_RESULT_TABLE[i].ComputedYet = "TRUE") AND ;;
       (SCX_CPU1_CS_MEM_RESULT_TABLE[i].BaselineCRC <> 0) AND ;;
...
for i = 0 to CS_MAX_NUM_MEMORY_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_MEM_RESULT_TABLE[i].State = "Enabled") AND (foundSeg = FALSE) then
    segIndex = i
    foundSeg = TRUE
  endif
enddo
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_DISABLE_MEMORY_ENTRY_INF_EID,"INFO",1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Disable Entry Command
/SCX_CPU1_CS_DisableMemoryEntry EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_MEMORY_ENTRY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6004, "F"
endif
...
s get_tbl_to_cvt (ramDir,memDefTblName,"A","cpu1_usrdeftbl2_6",hostCPU,defTblId)
wait 5

if (p@SCX_CPU1_CS_MEM_DEF_TABLE[segindex].State = "Disabled") then
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl2_7",hostCPU,resTblId)
wait 5
...
/SCX_CPU1_TST_CS_CorruptMemCRC MemType=TST_CS_USER_MEM EntryID=segIndex
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_ENABLE_MEMORY_ENTRY_INF_EID,"INFO", 1
ut_setupevents "SCX","CPU1",{CSAppName},CS_MEMORY_MISCOMPARE_ERR_EID,"ERROR", 2

write "*** Memory Segment Miscompare Ctr = ",SCX_CPU1_CS_MemoryEC

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable Entry Command
/SCX_CPU1_CS_EnableMemoryEntry EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_MEMORY_ENTRY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6003, "F"
endif

;; Check that the miscompare event message was rcvd
ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1, 60
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (6000.1) - Expected Event Msg ",CS_MEMORY_MISCOMPARE_ERR_EID," rcv'd."
  ut_setrequirements CS_60001, "P"
else
  write "<!> Failed (6000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_MEMORY_MISCOMPARE_ERR_EID,"."
  ut_setrequirements CS_60001, "F"
endif

write "*** Memory Miscompare Ctr = ",SCX_CPU1_CS_MemoryEC
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl2_10",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_MEMORY_STARTED_DBG_EID, "DEBUG", 1
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID, "INFO", 2

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeMemory EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_MEMORY_STARTED_DBG_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6005, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6005.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeMemory EntryID=1
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_MEMORY_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Report Command
/SCX_CPU1_CS_ReportMemory EntryID=segIndex
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6006) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_EEPROM_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6006, "F"
endif
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl2_13",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
write ";  Step 2.14: Send the Get User-Defined Entry ID command using an   "
write ";  address of an entry in the results table. "
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{CSAppName},CS_GET_ENTRY_ID_MEMORY_INF_EID,"INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Get Memory Entry ID Command
/SCX_CPU1_CS_GetMemoryEntryID Address=SCX_CPU1_CS_MEM_RESULT_TABLE[1].StartAddr
...
if (SCX_CPU1_find_event[1].num_found_messages > 0) then
  write "<*> Passed (1003) - Expected Event Msg ",CS_GET_ENTRY_ID_MEMORY_INF_EID," rcv'd."
  ut_setrequirements CS_1003, "P"
  ut_setrequirements CS_6009, "P"
else
  write "<!> Failed (1003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_GET_ENTRY_ID_MEMORY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6009, "F"
endif
...
write ";  invalid ID."
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_ENABLE_MEMORY_INVALID_ENTRY_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Enable Entry Command
/SCX_CPU1_CS_EnableMemoryEntry EntryID=CS_MAX_NUM_MEMORY_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;6007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_ENABLE_MEMORY_INVALID_ENTRY_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_6007, "F"
endif
...
write ";  invalid ID."
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_DISABLE_MEMORY_INVALID_ENTRY_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Disable Entry Command
/SCX_CPU1_CS_DisableMemoryEntry EntryID=CS_MAX_NUM_MEMORY_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;6007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_DISABLE_MEMORY_INVALID_ENTRY_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_6007, "F"
endif
...
write ";  an invalid ID. "
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_INVALID_ENTRY_MEMORY_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Recompute Command
/SCX_CPU1_CS_RecomputeMemory entryID=CS_MAX_NUM_MEMORY_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;6007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_INVALID_ENTRY_MEMORY_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_6007, "F"
endif
...
write ";  invalid ID."
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_BASELINE_INVALID_ENTRY_MEMORY_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Report Command
/SCX_CPU1_CS_ReportMemory entryID=CS_MAX_NUM_MEMORY_TABLE_ENTRIES
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;6007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_INVALID_ENTRY_MEMORY_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_6007, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_GET_ENTRY_ID_MEMORY_NOT_FOUND_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Get Entry ID Command
/SCX_CPU1_CS_GetMemoryEntryID Address=SCX_CPU1_CS_MEM_RESULT_TABLE[0].StartAddr-1000

ut_tlmwait SCX_CPU1_CS_CMDPC, {cmdCtr}, 5
if (UT_TW_Status = UT_Success) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;6007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_GET_ENTRY_ID_MEMORY_NOT_FOUND_INF_EID,"."
  ut_setrequirements CS_1004, "F"
  ut_setrequirements CS_6007, "F"
endif
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl3_13",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_MEMORY_CHDTASK_ERR_EID, "ERROR", 1
ut_setupevents "SCX", "CPU1", {CSAppName}, CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID, "INFO", 2

errcnt = SCX_CPU1_CS_CMDEC + 1
;; Send the Command
/SCX_CPU1_CS_RecomputeMemory EntryID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_RECOMPUTE_MEMORY_CHDTASK_ERR_EID,"."
  ut_setrequirements CS_1004, "F"
endif
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_1",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_5",hostCPU,resTblId)
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6006) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",CS_BASELINE_MEMORY_INF_EID,"."
  ut_setrequirements CS_1003, "F"
  ut_setrequirements CS_6006, "F"
endif
...
for i = 0 to CS_MAX_NUM_MEMORY_TABLE_ENTRIES-1 DO
  if (p@SCX_CPU1_CS_MEM_RESULT_TABLE[i].State = "Disabled") AND (foundSeg = FALSE) then
    segIndex = i
    foundSeg = TRUE
  endif
enddo
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_10",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_16",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_21",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_28",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_33",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_39",hostCPU,resTblId)
wait 5
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl4_44",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
;; Send the Command
/SCX_CPU1_CS_RecomputeMemory EntryID=6
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",2
ut_setupevents "SCX","CPU1",{CSAppName},CS_RECOMPUTE_FINISH_EEPROM_MEMORY_INF_EID,"INFO",3
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl5_6",hostCPU,resTblId)
wait 5
...
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_MEMORY_RANGE_ERR_EID, "ERROR", 3
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_MEMORY_INF_EID, "INFO", 4
...
if (SCX_CPU1_find_event[4].num_found_messages = 1) then
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=memDefTblName
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID,"DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID, "ERROR", 2
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_MEMORY_STATE_ERR_EID,"ERROR", 3
ut_setupevents "SCX","CPU1",{CSAppName},CS_VAL_MEMORY_INF_EID, "INFO", 4
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - User-defined Memory Definition Table validation event '", SCX_CPU1_find_event[2].eventid,"' found!"
else
  write "<!> Failed - User-defined Memory Definition Table validation event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",CFE_TBL_VALIDATION_INF_EID, "."
endif
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl5_13",hostCPU,resTblId)
wait 5
...
cmdCtr = SCX_CPU1_CS_CMDPC + 1
;; Send the Enable Entry Command
/SCX_CPU1_CS_EnableMemoryEntry EntryID=2
...
while (keepDumpingResults = FALSE) do
  s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl6_5",hostCPU,resTblId)
  wait 3

  ;; Loop for each valid entry in the results table
  for i = 0 to CS_MAX_NUM_MEMORY_TABLE_ENTRIES-1 DO
    ;; If the entry is valid and the Offset or tempCRC are not zero -> Stop
    if (p@SCX_CPU1_CS_MEM_RESULT_TABLE[i].State <> "Empty") AND ;;
       (SCX_CPU1_CS_MEM_RESULT_TABLE[i].ByteOffset <> 0) OR ;;
       (SCX_CPU1_CS_MEM_RESULT_TABLE[i].TempCRC <> 0) AND ;;
...
s get_tbl_to_cvt (ramDir,memResTblName,"A","cpu1_usrrestbl7_4",hostCPU,resTblId)
wait 5
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_usermem"
write ";*********************************************************************"
ENDPROC
