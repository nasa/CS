...
SCX_CPU1_CS_EEPROM_DEF_TABLE[0].State = 7
...
SCX_CPU1_CS_EEPROM_DEF_TABLE[1].State = CS_STATE_DISABLED
SCX_CPU1_CS_EEPROM_DEF_TABLE[1].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]+16
SCX_CPU1_CS_EEPROM_DEF_TABLE[1].NumBytes = 2048
...
s create_tbl_file_from_cvt (hostCPU,defTblId,"EEPROM Definition Table Invalid State","eeprom_bad_state",eeDefTblName,"SCX_CPU1_CS_EEPROM_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_cs_edt5                              "
write ";*********************************************************************"
ENDPROC
