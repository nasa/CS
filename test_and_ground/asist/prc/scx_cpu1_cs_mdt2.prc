...
local ovrlapAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry] + SCX_CPU1_TST_CS_Size[eepromEntry]
ovrlapAddr = ovrlapAddr - 1000
local invalidAddr = SCX_CPU1_TST_CS_StartAddr[ramEntry] - 2000
...
SCX_CPU1_CS_MEM_DEF_TABLE[0].State = CS_STATE_DISABLED
SCX_CPU1_CS_MEM_DEF_TABLE[0].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]
SCX_CPU1_CS_MEM_DEF_TABLE[0].NumBytes = SCX_CPU1_TST_CS_Size[eepromEntry]
SCX_CPU1_CS_MEM_DEF_TABLE[1].State = CS_STATE_ENABLED
SCX_CPU1_CS_MEM_DEF_TABLE[1].StartAddr = SCX_CPU1_TST_CS_StartAddr[ramEntry]
SCX_CPU1_CS_MEM_DEF_TABLE[1].NumBytes = ramQuarterSize
SCX_CPU1_CS_MEM_DEF_TABLE[2].State = CS_STATE_ENABLED
SCX_CPU1_CS_MEM_DEF_TABLE[2].StartAddr = ovrlapAddr
SCX_CPU1_CS_MEM_DEF_TABLE[2].NumBytes = 2048
SCX_CPU1_CS_MEM_DEF_TABLE[3].State = CS_STATE_ENABLED
SCX_CPU1_CS_MEM_DEF_TABLE[3].StartAddr = invalidAddr
SCX_CPU1_CS_MEM_DEF_TABLE[3].NumBytes = 2048
SCX_CPU1_CS_MEM_DEF_TABLE[4].State = 4
SCX_CPU1_CS_MEM_DEF_TABLE[4].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]+16
...
s create_tbl_file_from_cvt (hostCPU,defTblId,"User-defined Memory Definition Table Invalid Load","usrmem_def_invalid",memDefTblName,"SCX_CPU1_CS_MEM_DEF_TABLE[0].State",endmnemonic)

;; Correct the overlapping address (Illegal range error)
SCX_CPU1_CS_MEM_DEF_TABLE[2].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]

;; Create a table load file that should not pass validation
s create_tbl_file_from_cvt (hostCPU,defTblId,"User-defined Memory Definition Table Invalid Load","usrmem_def_invalid2",memDefTblName,"SCX_CPU1_CS_MEM_DEF_TABLE[0].State",endmnemonic)
wait 5

;; Create a table load file with only an invalid state
SCX_CPU1_CS_MEM_DEF_TABLE[0].State = 4
SCX_CPU1_CS_MEM_DEF_TABLE[0].StartAddr = SCX_CPU1_TST_CS_StartAddr[eepromEntry]
SCX_CPU1_CS_MEM_DEF_TABLE[0].NumBytes = 16
...
s create_tbl_file_from_cvt (hostCPU,defTblId,"User-defined Memory Definition Table Invalid Load","usrmem_def_invalid3",memDefTblName,"SCX_CPU1_CS_MEM_DEF_TABLE[0].State",endmnemonic)
wait 5

write ";*********************************************************************"
write ";  End procedure scx_cpu1_cs_mdt2                              "
write ";*********************************************************************"
ENDPROC
